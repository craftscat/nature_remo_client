...
class UpdateDeviceHumidityTest < Minitest::Test
  def test_update_device_humidity_offset_success
    ...
    assert_equal '{}', @client.update_device_humidity_offset(device_id: '3fa85f64-5717-4562-b3fc-2c963f66afa6', offset: 1)
  end

  def test_update_device_humidity_offset_auth_failure
    @client = NatureRemo::Client.new('token-xxxxx')
    WebMock.stub_request(:post, 'https://api.nature.global/1/devices/3fa85f64-5717-4562-b3fc-2c963f66afa6/humidity_offset')
           .with(
             headers: {
