...
class DeleteDeviceTest < Minitest::Test
  def test_delete_device_success
    @client = NatureRemo::Client.new('token-xxxxx')
    WebMock.stub_request(:post, 'https://api.nature.global/1/devices/3fa85f64-5717-4562-b3fc-2c963f66afa6/delete')
           .with(
             headers: {
               'Accept' => '*/*',
    ...
    assert_equal '{}', @client.delete_device(device_id: '3fa85f64-5717-4562-b3fc-2c963f66afa6')
  end

  def test_delete_device_auth_failure
    @client = NatureRemo::Client.new('token-xxxxx')
    WebMock.stub_request(:post, 'https://api.nature.global/1/devices/3fa85f64-5717-4562-b3fc-2c963f66afa6/delete')
           .with(
             headers: {
    ...
    error = assert_raises NatureRemo::Unauthorized do
      @client.delete_device(device_id: '3fa85f64-5717-4562-b3fc-2c963f66afa6')
    end

    assert_equal 'request failed with status code 401, {"code": 401001, "message": "認証エラー"}', error.message
  end

  def test_delete_device_auth_internal_server_error
    @client = NatureRemo::Client.new('token-xxxxx')
    WebMock.stub_request(:post, 'https://api.nature.global/1/devices/3fa85f64-5717-4562-b3fc-2c963f66afa6/delete')
           .with(
             headers: {
  ...
  def test_delete_device_timeout
    @client = NatureRemo::Client.new('token-xxxxx')
    WebMock.stub_request(:post, 'https://api.nature.global/1/devices/3fa85f64-5717-4562-b3fc-2c963f66afa6/delete')
           .with(
             headers: {
